from diachrony_for_russianmaster.algos import GlobalAnchors, Jaccard, KendallTau, ProcrustesAligner
from argparse import ArgumentParser
from diachrony_for_russianmaster.utils import load_model
import os
